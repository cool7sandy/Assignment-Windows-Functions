CREATE TABLE "mytable" (
  "1. **Rank the customers based on the total amount they've spent on rentals.**" text NULL
);

INSERT INTO "mytable" ("1. **Rank the customers based on the total amount they've spent on rentals.**")
VALUES
('SELECT'),
('customer_id'),
...
('8. **Calculate the running total of rentals per category'),
